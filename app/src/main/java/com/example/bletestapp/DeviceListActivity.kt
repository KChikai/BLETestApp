...
class DeviceListActivity : AppCompatActivity(), AdapterView.OnItemClickListener {
    ...
    class DeviceListAdapter(activity: Activity) : BaseAdapter() {
        ...
        private val mDeviceList: ArrayList<BluetoothDevice> = ArrayList()
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View? {
            ...
            if (null == convertView) {
                convertView = mInflator.inflate(R.layout.listitem_devices, parent, false)
            ...
            if (null != deviceName && deviceName.isNotEmpty()) {
    ...
    // 定数
    private val REQUEST_ENABLE_BLUETOOTH = 1 // Bluetooth機能の有効化要求時の識別コード
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        when (requestCode) {
            REQUEST_ENABLE_BLUETOOTH -> if (RESULT_CANCELED == resultCode) {    // 有効にされなかった
